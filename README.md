...
## Installation
### Method 1(Running The .Jar)
**:bangbang::bangbang:Imprtant Note:bangbang::bangbang:: This Requires Atleaset Java 8(You Can Get it from [Here](https://www.java.com/en/download/))** 

simply just download the latest release and run the **Shawarma Calculator.jar** and your done!
